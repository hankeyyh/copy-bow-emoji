      ...
      <div className="text-center">
        ...
        <div className="flex gap-30 mt-30 justify-center">
          <button
            ...
            className="flex items-center gap-1 px-2 py-1 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors duration-200 text-xs"
          >
          ...
          <button
            onClick={shareOnX}
            className="flex items-center gap-1 px-2 py-1 bg-black hover:bg-gray-800 text-white rounded-lg transition-colors duration-200 text-xs"
          >
            <svg className="w-3 h-3" fill="currentColor" viewBox="0 0 24 24">
